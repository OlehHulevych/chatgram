...
export default function Contact({chatName,  latestMessage, key}:contactProps) {

  const {setSelectedChat} = useChat()
  
  return (
    <div onClick={()=>setSelectedChat(key)}  className='w-full relative hover:bg-cyan-500 pl-1 pt-1 cursor-pointer'>
